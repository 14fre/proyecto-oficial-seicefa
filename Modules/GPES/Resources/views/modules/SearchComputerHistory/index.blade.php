...
<h1>Historial de computador</h1>

<form action="{{ route('gpes.cuentadante.Search.computer.Search') }}" method="GET" class="mb-4">
    <div class="input-group">
        <input type="text" name="serial_number" class="form-control" placeholder="Ingrese el serial del computador" required>
 ...
 <!-- Details Modal -->
    ...
    @forelse ($assignments as $assignment)
        ...
        <div class="assignment-container" style="width: 95%;  ">
