    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-primary">
                <i class="bi bi-laptop me-2"></i>Asignaciones de Computadores por Día
            </h2>
            <a href="{{ route('gpes.cuentadante.assignmentsUserComputer.day.create') }}" class="btn btn-success shadow-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex gap-2 justify-content-end">
                                            ...
                                            <!-- Botón Editar -->
                                            <a href="{{ route('gpes.cuentadante.assignmentsUserComputer.day.edit', $assignment->id) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow-sm rounded-3">
                                            ...
                                            <div class="modal-footer border-0">
                                                <form action="{{ route('gpes.cuentadante.assignmentsUserComputer.day.return', $assignment->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                ...
                                <div class="modal fade" id="deleteModal{{ $assignment->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow-sm rounded-3">
                                            ...
                                            <div class="modal-footer border-0">
                                                <form action="{{ route('gpes.cuentadante.assignmentsUserComputer.day.destroy', $assignment->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            modalElements.forEach(function(modal) {
                modal.addEventListener('shown.bs.modal', function () {
                    // Asegura que el modal se inicie correctamente
                });
            ...
            // Manejar el envío del formulario para evitar estados bloqueados
            var forms = document.querySelectorAll('.modal form');
            forms.forEach(function(form) {
                form.addEventListener('submit', function() {
                    // Opcional: Forzar el cierre del modal tras el envío (si el backend redirige)
