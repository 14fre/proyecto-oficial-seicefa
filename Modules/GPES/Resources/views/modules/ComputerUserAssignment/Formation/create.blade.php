    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-primary">
                <i class="bi bi-laptop me-2"></i>Asignar Computador por Formación
            </h2>
        </div>
        ...
        <div class="card shadow-sm border-0 rounded-3 overflow-hidden">
            <div class="card-body p-4">
                <form action="{{ route('gpes.cuentadante.assignmentsUserComputer.formation.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <!-- Fila: Fecha Asignación + Fecha Devolución -->
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="returned_at" class="form-label fw-semibold">Fecha y Hora de Finalización de la Formación</label>
                            <input type="datetime-local"
                                   name="returned_at"
                                   id="returned_at"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="observation"
                                  ...
                                  placeholder="Notas adicionales (opcional)">{{ old('observation') }}</textarea>
                        @error('observation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-3">
                        <button type="submit" class="btn btn-primary px-4 py-2 shadow-sm">
                            <i class="bi bi-save me-1"></i>Asignar Computador
                        </button>
                        <a href="{{ route('gpes.cuentadante.assignmentsUserComputer.formation.index') }}" class="btn btn-secondary px-4 py-2 shadow-sm">
