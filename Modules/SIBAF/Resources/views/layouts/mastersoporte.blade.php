...
<head>
  ...
  <style>
    ...
    .slide-aprendices .sena-icon { color: #28a745; }
    .slide-programas .sena-icon { color: #007bff; }
    .slide-instructores .sena-icon { color: #17a2b8; }
    .slide-centros .sena-icon { color: #28a745; }
    .slide-certificaciones .sena-icon { color: #6c757d; }
